...
//N	33.84	pulverize,if=buff.pulverize.remains<0.5
            await Spell.CoCast(Pulverize, Me.HasAuraExpired("Pulverize", 1));
//O	13.50	lacerate,if=talent.pulverize.enabled&buff.pulverize.remains<=(3-dot.lacerate.stack)*gcd&buff.berserk.down
            await Spell.CoCast(Lacerate, (Me.HasAuraExpired("Pulverize", 3) && buffStackCount(Lacerate, Me.CurrentTarget) < 3) || !Me.CurrentTarget.HasAura(Lacerate));
