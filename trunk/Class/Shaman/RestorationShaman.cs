...
namespace SlimAI.Class.Shaman
{
    class RestorationShaman
    {
        ...
        {
            return new PrioritySelector(
                Spell.Cast(WaterShield, on => Me, ret => !Me.HasAura("Water Shield")),
        ...
        private static WoWUnit GetBestEarthShieldTargetInstance()
        {
            ...
            if (Unit.NearbyFriendlyPlayers.Any(m => m.HasAura("Earth Shield")))
                return null;
        ...
        private static Composite RiptideCast()
        {
