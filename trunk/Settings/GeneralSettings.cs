...
namespace SlimAI.Settings
{
    ...
    internal class GeneralSettings : Styx.Helpers.Settings
    {
        ...
        public static string SlimAISettingsPath
        {
            get
            {
                string settingsDirectory = Path.Combine(Styx.Common.Utilities.AssemblyDirectory, "Settings");
                return Path.Combine(Path.Combine(Path.Combine(settingsDirectory, StyxWoW.Me.RealmName), StyxWoW.Me.Name), "SlimAI");
            }
        }
        ...
        public void LogSettings()
        {
            ...
            LogSettings("SlimAI", GeneralSettings.Instance);
