...
namespace SlimAI.Helpers
{
    ...
    internal static class Spell
    {
...
#else
            Logging.Write("FixGlobalCooldownInitialize: using SlimAI GCD");
        ...
        /// <param name = "requirements">The requirements.</param>
        /// <returns>.</returns>
        public static Composite Cast(int spellId, SimpleBooleanDelegate requirements, bool returnFailure = false)
        {
            return Cast(spellId, ret => StyxWoW.Me.CurrentTarget, requirements, returnFailure);
        }
        ...
        /// <param name = "requirements">The requirements.</param>
        /// <returns>.</returns>
        public static Composite Cast(int spellId, UnitSelectionDelegate onUnit, SimpleBooleanDelegate requirements, bool returnFailure = false)
        {
            return Cast(id => spellId, onUnit, requirements, returnFailure);
        }
        ...
        /// <param name = "requirements">The requirements.</param>
        /// <returns>.</returns>
        public static Composite Cast(SimpleIntDelegate spellId, UnitSelectionDelegate onUnit, SimpleBooleanDelegate requirements, bool returnFailure = false)
        {
            return
